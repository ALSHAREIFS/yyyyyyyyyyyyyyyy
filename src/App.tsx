...
const MENU_ITEMS = [
  {
    id: 1,
    name: "Golden Truffle Nasi Lemak",
    price: "SAR 145",
    description: "Cloud-like coconut rice served with our signature spicy truffle sambal, crispy anchovies, and slow-boiled farm egg.",
    image: "/nasi-lemak.jpg",
    tag: "Signature"
  },
  {
    id: 2,
    name: "Wagyu Satay Skewers",
    price: "SAR 185",
    description: "Tender A5 Wagyu beef skewers, charcoal-grilled to smoky perfection, served with velvet-smooth peanut reduction.",
    image: "https://images.unsplash.com/photo-1564834724105-918b73d1b9e0?auto=format&fit=crop&w=800&q=80",
    tag: "Popular"
  },
  {
    id: 3,
    name: "Saffron Spiced Sarawak",
    price: "SAR 110",
    description: "Aromatic broth infused with saffron and 12 secret spices, served over thin vermicelli and fresh mountain herbs.",
    image: "https://images.unsplash.com/photo-1582878826629-29b7ad1cdc43?auto=format&fit=crop&w=800&q=80",
    tag: "Chef's Choice"
  },
  {
    id: 4,
    name: "Lobster Kway Teow",
    price: "SAR 220",
    description: "Wok-fried flat noodles with a deep smoky essence, plump lobster meat, and premium chives.",
    image: "https://images.unsplash.com/photo-1543363363-2fceacb7b6c8?auto=format&fit=crop&w=800&q=80"
  },
  {
    id: 5,
    name: "Heritage Ayam Penyet",
    price: "SAR 130",
...
const REVIEWS = [
  {
    ...
    photoCount: 18,
    time: "2 weeks ago",
    content: "Absolutely phenomenal dining experience. The ambiance is spectacular and the dishes are meticulously crafted. The spices are perfectly balanced. Highly recommended for special occasions.",
    rating: 5
  },
  {
    id: 2,
    ...
    photoCount: 304,
    time: "1 month ago",
    content: "A hidden gem in the city. The service was impeccable, though the waiting time for the main course was slightly longer than expected. The dessert menu is out of this world.",
    rating: 4
  },
  {
    id: 3,
    ...
    photoCount: 112,
    time: "3 months ago",
    content: "We came here for our anniversary and it exceeded all expectations. The staff went above and beyond to make our evening special. The signature lamb dish is a must-try!",
    rating: 5
  },
  {
    id: 4,
    ...
    photoCount: 5,
    time: "4 months ago",
    content: "Very elegant interior and luxurious feel. The food portions are a bit small for the price, but the quality and taste are undeniably premium. A great place to impress guests.",
    rating: 4
  },
  {
    id: 5,
    ...
    photoCount: 1050,
    time: "6 months ago",
    content: "I've been to many fine dining restaurants, but Wertol stands out for its unique flavor profiles and extraordinary plating. Every dish is a work of art.",
    rating: 5
  },
  {
    id: 6,
    ...
    photoCount: 410,
    time: "1 year ago",
    content: "An unforgettable culinary journey. From the appetizers to the mocktails, everything was perfect. Make sure to book in advance because it gets quite busy on weekends.",
    rating: 5
  }
];
...
const REVIEW_TAGS = [
  { name: "All", count: 845 },
  { name: "signature dish", count: 120 },
  { name: "ambiance", count: 85 },
  { name: "service", count: 64 },
  { name: "dessert", count: 42 }
];
...
const EXPERIENCES = [
  ...
  },
  {
    ...
    desc: "A perfect blend of modern luxury and traditional Wertol heritage."
  },
  {
      ...
      >
        <div className="max-w-7xl mx-auto px-6 lg:px-12 h-full flex items-center justify-between">
          ...
          >
            ...
            <span className="font-serif text-2xl font-bold tracking-tighter text-white">WERTOL</span>
          </motion.div>
          ...
          >
            ...
            <div className="mt-auto pb-12 pt-8 border-t border-white/10 flex flex-col gap-6">
              ...
              <p className="text-neutral-500 text-[10px] uppercase tracking-[0.2em] font-bold">
                Experience Harmony &bull; Wertol Fine Dining
              </p>
            </div>
          </motion.div>
        )}
          ...
          >
            ...
            <div className="max-w-7xl mx-auto px-6 pt-12 border-t border-white/5 text-center">
              <p className="text-neutral-600 text-[10px] font-bold uppercase tracking-[0.3em]">
                Authenticity in every bite &bull; Wertol Fine Dining
              </p>
            </div>
          </motion.div>
        ) : (
      ...
      <section className="relative h-screen flex items-center justify-center overflow-hidden">
        <div className="absolute inset-0 z-0">
          ...
          >
            ...
            <img 
              src={heroFoodImage} 
              alt="WERTOL Luxury Malaysian Fine Dining" 
        ...
        <div className="max-w-7xl mx-auto px-6 relative z-20 text-center">
          ...
          >
            ...
            >
              <TypingEffect text="Explore a curated selection of traditional Malaysian dishes, reimagined through modern culinary excellence in the heart of Riyadh." />
            </motion.p>
            ...
            <motion.div variants={itemVariants} className="flex flex-col sm:flex-row flex-wrap justify-center gap-4 md:gap-6">
              ...
              <motion.a 
                href="https://maps.app.goo.gl/SnuFiX77T1xW9yLP6"
                target="_blank"
                rel="noopener noreferrer"
                whileHover={{ scale: 1.05 }}
                whileTap={{ scale: 0.95 }}
          ...
          <div className="grid lg:grid-cols-2 gap-20 items-center">
            ...
            >
              <div className="flex items-center gap-3 mb-6">
                ...
                <span className="text-amber-500 font-bold uppercase tracking-[0.3em] text-[10px]">The Wertol Story</span>
              </div>
              ...
              <p className="text-lg text-neutral-400 mb-10 font-light leading-relaxed">
                Inspired by the rhythmic beauty of Wertol music, our restaurant is a celebration of balance. Every recipe is a tribute to Malaysian heritage, reimagined for the modern palate.
              </p>
              <div className="grid grid-cols-2 gap-10">
                <div className="space-y-1">
                  <span className="block text-3xl font-serif font-bold text-white">4.8</span>
            ...
            >
              ...
              <div className="p-8 rounded-[40px] bg-neutral-900 border border-white/5 space-y-6 shadow-2xl">
                <div className="flex items-center gap-6">
                  <span className="text-7xl font-serif font-bold text-white leading-none">4.8</span>
                  <div className="space-y-1">
                    ...
                    <p className="text-neutral-400 text-xs font-bold uppercase tracking-widest">845 Reviews</p>
                  </div>
                </div>
          ...
          >
            <div>
              ...
              <p className="text-neutral-400 text-lg font-light leading-relaxed max-w-md">
                Located in the vibrant Al Olaya district, our space offers a perfect escape for fine dining and cultural immersion.
              </p>
            </div>
              ...
              <div className="flex gap-4 items-start">
                ...
                <div>
                  ...
                  <p className="text-neutral-500 text-sm leading-relaxed">
                    7742 King Fahd Road, Al Olaya,<br />
      ...
      <footer id="contact" className="pt-24 pb-12 bg-black">
        <div className="max-w-7xl mx-auto px-6">
          <div className="grid lg:grid-cols-4 gap-16 mb-20">
            <div className="col-span-2 space-y-8">
              <div className="flex items-center gap-3">
                ...
                <span className="font-serif text-3xl font-bold text-white tracking-tighter">WERTOL</span>
              </div>
                ...
                <div className="space-y-4">
                  ...
                  <div className="flex gap-6 items-center">
                    ...
                    <div>
                      ...
                      <a href="tel:+9660508177328" className="text-white font-serif text-3xl md:text-4xl font-bold hover:text-amber-500 transition-colors tracking-tight">+966 050 817 7328</a>
                    </div>
                  </div>
                  <div className="flex flex-col sm:flex-row gap-4">
                    <motion.a 
                      href="tel:+9660508177328" 
                      whileHover={{ scale: 1.05 }}
                  ...
                  <div className="flex gap-6 items-start">
                    ...
                    <div>
                      <p className="text-neutral-300 text-lg md:text-xl font-medium leading-relaxed max-w-sm">
                        7742 King Fahd Road, Al Olaya, Riyadh 12214, Saudi Arabia
                      </p>
                    </div>
                  </div>
                </div>
          ...
          <div className="pt-8 border-t border-white/5 text-center">
            <p className="text-neutral-600 text-[10px] font-bold uppercase tracking-[0.3em]">
              &copy; {new Date().getFullYear()} Wertol Fine Dining. Built with Harmony.
            </p>
          </div>
        </div>
      </footer>
